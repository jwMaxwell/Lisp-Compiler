...
inline llvm::Value *add_codegen(std::vector<node_ptr> children) {
...
inline llvm::Value *sub_codegen(std::vector<node_ptr> children) {
...
inline llvm::Value *mul_codegen(std::vector<node_ptr> children) {
...
inline llvm::Value *div_codegen(std::vector<node_ptr> children) {
